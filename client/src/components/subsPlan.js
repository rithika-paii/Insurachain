...
function SubsPlan() {
    ...
    const data = [
        ...
        { plan: "2", disease: "diabetes, epilepsy, jaundice", subscriptionAmount: "20", claimAmount: "10"},
        { plan: "3", disease: "alzheimer, cancer, fibrosis", subscriptionAmount: "30", claimAmount: "10"},
      ]
